...
const HighchartSankey = () => {
    ...
    }, [dateRange, setData, selectedAgencies, selectedPartners, selectedCounties, selectedSubCounties, selectedGender, selectedAgeGroup]);
    ...
    const handleNodeClick = useCallback( async () => {
        ...
        setLoading(false)
    }, [selectedNode, dateRange, selectedAgencies, selectedPartners, selectedCounties, selectedSubCounties, selectedGender, selectedAgeGroup]);

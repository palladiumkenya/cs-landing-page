...
const Filters = ({
                     agencies, partners, counties, subCounties, genders, ageGroups,
                     setSelectedAgencies, setSelectedPartners, setSelectedCounties, setSelectedSubCounties, setSelectedGender, setSelectedAgeGroup,
                     selectedCounties, selectedSubcounties, selectedAgencies, selectedPartners, selectedGender, selectedAgeGroup
}) => {
